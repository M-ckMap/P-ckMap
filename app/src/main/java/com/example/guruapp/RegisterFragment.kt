            ...
            if (user == "") {
                ...
                if (Pattern.matches(idPattern, user)) {
                    ...
                    if(checkUsername == false){
                        CheckId = true
                        Toast.makeText(this@RegisterFragment, "사용 가능한 아이디입니다.", Toast.LENGTH_SHORT).show()
                    }
                    else {
                        Toast.makeText(this@RegisterFragment, "이미 존재하는 아이디입니다.", Toast.LENGTH_SHORT).show()
                    }
                }
                else {
                    Toast.makeText(this@RegisterFragment, "아이디 형식이 옳지 않습니다.", Toast.LENGTH_SHORT).show()
                }
            }
        }
        ...
        btnCheckNick.setOnClickListener {
            ...
            if (nick == "") {
                ...
                if (Pattern.matches(nickPattern, nick)) {
                    ...
                    if(checkNick == false){
                        CheckNick = true
                        Toast.makeText(this@RegisterFragment, "사용 가능한 닉네임입니다.", Toast.LENGTH_SHORT).show()
                    }
                    else {
                        Toast.makeText(this@RegisterFragment, "이미 존재하는 닉네임입니다.", Toast.LENGTH_SHORT).show()
                    }
                }
                else {
                    Toast.makeText(this@RegisterFragment, "닉네임 형식이 옳지 않습니다.", Toast.LENGTH_SHORT).show()
                }
            }
        }
        ...
        btnRegister.setOnClickListener {
            ...
            if (user == "" || pass == "" || repass == "" || nick == "" || phone == "") Toast.makeText(
                ...
                // 아이디 중복확인이 되지 않았을 때
                    ...
                    Toast.makeText(this@RegisterFragment, "아이디 중복확인을 해주세요.", Toast.LENGTH_SHORT)
                        .show()
                }
            }
        }
